...
Home: https://github.com/bluesky/blop

Package license: BSD-3-Clause

Summary: Bluesky optimization package
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/blop-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/blop-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `blop` available on your platform:
...
```
pixi search blop --channel conda-forge
```
